...
func (pc *PostgresClient) ListAssginmentById(id uuid.UUID) (*assignments_domain.Assignment, *interfaces.Error) {
	...
	result := pc.client.WithContext(spanCtx).First(&assigment, "id = ?", id)
